...
export function CardInfoForm() {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <form className="flex flex-col bg-zinc-700 rounded-md p-6 space-y-7 overflow-y-auto max-h-[75vh]" onSubmit={handleSubmit(onSubmit)}>
        ...
        <input type="submit" value="Save" className="p-2 rounded-xl bg-zinc-500 hover:bg-zinc-600" />
      </form>
    </div>
  );
}
